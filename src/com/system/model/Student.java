...
public class Student extends Person {
    ...
    // CHANGE 1: This list now strictly holds StudentCourse objects
    ...
    // CHANGE 2: The method now accepts a StudentCourse, not a Course
    public void registerCourse(StudentCourse studentCourse) {
        ...
        if (!this.registeredCourses.contains(studentCourse)) {
            ...
            // Notice how we have to call .getCourse() first to get the title now!
